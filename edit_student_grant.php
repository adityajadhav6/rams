...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        $update_stmt = $conn->prepare(
            "UPDATE student_grants SET project_name = ?, student_name = ?, department = ?, year_of_award = ?, amount_sanctioned = ?, duration = ?, funding_agency = ? WHERE id = ?"
        );
        ...
        if ($update_stmt->execute()) {
            header("Location: student_grants.php?success=2");
            exit();
        } else {
...
<html>
<head>
    <title>Edit Student Grant</title>
...
<div class="container">
    ...
    <form method="post" action="">
        ...
        <div class="form-group">
            ...
            <input type="text" name="student_name" id="student_name" value="<?php echo htmlspecialchars($grant['student_name']); ?>" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" name="amount" id="amount" value="<?php echo htmlspecialchars($grant['amount_sanctioned']); ?>" step="0.01" required>
        </div>
        <div class="form-group">
